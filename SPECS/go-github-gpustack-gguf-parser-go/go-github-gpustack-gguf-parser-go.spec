...
%define _name           gguf-parser-go
%define go_import_path  github.com/gpustack/gguf-parser-go

Name:           go-github-gpustack-gguf-parser-go
Version:        0.24.1
Release:        %autorelease
...
Provides:       go(github.com/gpustack/gguf-parser-go) = %{version}
