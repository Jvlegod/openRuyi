...
%define _name           go-getter
%define go_import_path  github.com/hashicorp/go-getter

Name:           go-github-hashicorp-go-getter
Version:        1.8.6
Release:        %autorelease
...
Provides:       go(github.com/hashicorp/go-getter) = %{version}
