...
%define _name           fangs
%define go_import_path  github.com/anchore/fangs

Name:           go-github-anchore-fangs
Version:        0.1.1
Release:        %autorelease
Summary:        Go library packaged for syft dependency resolution
License:        Apache-2.0
URL:            https://github.com/anchore/fangs
#!RemoteAsset
...
Provides:       go(github.com/anchore/fangs) = %{version}
