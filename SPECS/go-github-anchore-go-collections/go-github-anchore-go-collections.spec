...
%define _name           go-collections
%define go_import_path  github.com/anchore/go-collections

Name:           go-github-anchore-go-collections
Version:        0.1.1
Release:        %autorelease
...
Provides:       go(github.com/anchore/go-collections) = %{version}
