...
%define _name           go-macholibre
%define go_import_path  github.com/anchore/go-macholibre

Name:           go-github-anchore-go-macholibre
Version:        0.1.1
Release:        %autorelease
...
Provides:       go(github.com/anchore/go-macholibre) = %{version}
