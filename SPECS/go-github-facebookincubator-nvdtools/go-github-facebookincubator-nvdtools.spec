...
%define _name           nvdtools
%define go_import_path  github.com/facebookincubator/nvdtools

Name:           go-github-facebookincubator-nvdtools
Version:        0.1.5
Release:        %autorelease
...
Provides:       go(github.com/facebookincubator/nvdtools) = %{version}
