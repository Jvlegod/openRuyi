...
%define _name           tools-golang
%define go_import_path  github.com/spdx/tools-golang

Name:           go-github-spdx-tools-golang
Version:        0.6.0-rc4
Release:        %autorelease
...
Provides:       go(github.com/spdx/tools-golang) = %{version}
